      ...
      >
        ...
        <template v-slot:item="{ item, index }">
          <tr>
            ...
            <td class="font-weight-medium"><button @click="openPhoto(item?.photo_in)"><img :src="item?.photo_in" alt="Photo In" style="width: 100px; height: 100px;"></button></td>
            <td class="font-weight-medium">{{ item?.kilometer_in }}</td>
            <td class="font-weight-medium">{{ formatDate(item?.date_out) }}</td>
            <td class="font-weight-medium"><button @click="openPhoto(item?.photo_out)"><img :src="item?.photo_out" alt="Photo Out" style="width: 100px; height: 100px;"></button></td>
...
<script>
  ...
  import { createData, deleteData, updateData, getAll } from '@/api/reimburseBbmService'
    ...
    data() {
      return {
        ...
        tableHeaders: [
          ...
          { text: 'Date In', value: 'date_in', sortable: false, class: 'text-left font-weight-bold', width: '15%' },
          { text: 'Photo In', value: 'photo_in', sortable: false, class: 'text-left font-weight-bold', width: '5%' },
          { text: 'Kilometer In', value: 'kilometer_in', sortable: false, class: 'text-left font-weight-bold', width: '8%' },
          { text: 'Date Out', value: 'date_out', sortable: false, class: 'text-left font-weight-bold', width: '15%' },
          { text: 'Photo Out', value: 'photo_out', sortable: false, class: 'text-left font-weight-bold', width: '5%' },
          { text: 'Kilometer Out', value: 'kilometer_out', sortable: false, class: 'text-left font-weight-bold', width: '8%' },
          { text: 'Description', value: 'description', sortable: false, class: 'text-left font-weight-bold', width: '15%' },
